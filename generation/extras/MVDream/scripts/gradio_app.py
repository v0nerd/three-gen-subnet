    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column():
                ...
                use_camera = gr.Checkbox(
                    value=True,
                    label="Multi-view Mode",
                    info="Multi-view mode or not (indepedent images)",
                )
        ...
        gr.Examples(
            [
                ...
                [
                    "higly detailed, majestic royal tall ship, realistic painting, by Charles Gregory Artstation and Antonio Jacobsen and Edward Moran, intricated details, blender, hyperrealistic, 4k, HD"
                ]
                + default_params,
            ],
            inputs,
